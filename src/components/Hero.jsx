    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        <div className='flex flex-col justify-center items-center mt-5'>
          <div className='w-5 h-5 rounded-full bg-[#d6d43f]' />
          <div className='w-1 sm:h-80 h-40 violet-gradient' />
        </div>

        <div>
          <h4 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#a88bf3]'>Sreeja</span>
          </h4>
          <p className={`${styles.heroSubText} mt-2 text-white`}>
          I am a Web Developer and an AI enthusiast. <br className='sm:block hidden' />
          I create art through my designs
          </p>
        </div>
      </div>
